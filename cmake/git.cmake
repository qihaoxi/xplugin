...
#   - 生成头写入源码树 include/xplugin/ 并加入 .gitignore：
#     好处是 IDE（CLion 等）按公共 include 路径直接能解析 build_info.c 的
#     引用（放构建目录时配不好 compile_commands 的 IDE 会标红）；代价是
#     源码树出现一个 gitignored 的生成产物（configure 时更新，不入库）。
...
function(xpl_generate_build_info out_header_var)
    ...
    # ---- 生成头（源码树 include/xplugin/，gitignored；见文件头注释）----
    set(_gen_dir "${XPLUGIN_PROJECT_ROOT}/include/xplugin")
