...
static const xpl_build_info_t g_xpl_build_info = {
	XPL_BUILD_GIT_COMMIT,	  XPL_BUILD_GIT_BRANCH,		 XPL_BUILD_TIMESTAMP, XPL_BUILD_OS,			  XPL_BUILD_DISTRO,
	XPL_BUILD_DISTRO_VERSION, XPL_BUILD_DISTRO_CODENAME, XPL_BUILD_KERNEL,	  XPL_BUILD_ARCH,		  XPL_BUILD_HOST,
	XPL_BUILD_COMPILER,		  XPL_BUILD_COMPILER_PATH,	 XPL_BUILD_LINKER,	  XPLUGIN_VERSION_STRING,
};
